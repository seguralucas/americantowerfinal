...
export class direccion1565285051331 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `municipalidad` ADD `direccion` varchar(255) NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `municipalidad` DROP COLUMN `direccion`");
    }
