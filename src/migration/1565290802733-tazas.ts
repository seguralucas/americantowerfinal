...
export class tazas1565290802733 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `tazas` ADD `minimacroDescripcion` mediumtext NULL");
        await queryRunner.query("ALTER TABLE `tazas` ADD `btsDescripcion` mediumtext NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `tazas` DROP COLUMN `btsDescripcion`");
        await queryRunner.query("ALTER TABLE `tazas` DROP COLUMN `minimacroDescripcion`");
    }
