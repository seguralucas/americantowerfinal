...
export class archivosReglamentacion1565119985959 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `archivo_reglamentacion` DROP COLUMN `titulo`");
        await queryRunner.query("ALTER TABLE `archivo_reglamentacion` ADD `resolucion` mediumtext NULL");
        await queryRunner.query("ALTER TABLE `archivo_reglamentacion` ADD `boletinOficial` mediumtext NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `archivo_reglamentacion` DROP COLUMN `boletinOficial`");
        await queryRunner.query("ALTER TABLE `archivo_reglamentacion` DROP COLUMN `resolucion`");
        await queryRunner.query("ALTER TABLE `archivo_reglamentacion` ADD `titulo` mediumtext NULL");
    }
