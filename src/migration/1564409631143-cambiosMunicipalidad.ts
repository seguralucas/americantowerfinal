...
export class cambiosMunicipalidad1564409631143 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `municipalidad` ADD `datosSolicitados` tinyint NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `municipalidad` DROP COLUMN `datosSolicitados`");
    }
