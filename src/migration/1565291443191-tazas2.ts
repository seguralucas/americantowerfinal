...
export class tazas21565291443191 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `tazas` CHANGE `metroAdicional` `metroAdicional` tinyint NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `tazas` CHANGE `metroAdicional` `metroAdicional` tinyint NOT NULL");
