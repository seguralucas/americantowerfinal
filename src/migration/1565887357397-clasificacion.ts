...
export class clasificacion1565887357397 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `contexto_politico` DROP COLUMN `clasificacion`");
        await queryRunner.query("ALTER TABLE `contexto_politico` ADD `clasificacion` float NULL");
        await queryRunner.query("ALTER TABLE `reglamentacion` DROP COLUMN `clasificacion`");
        await queryRunner.query("ALTER TABLE `reglamentacion` ADD `clasificacion` float NULL");
        ...
        await queryRunner.query("ALTER TABLE `tazas` DROP COLUMN `clasificacion`");
        await queryRunner.query("ALTER TABLE `tazas` ADD `clasificacion` float NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `tazas` DROP COLUMN `clasificacion`");
        await queryRunner.query("ALTER TABLE `tazas` ADD `clasificacion` int NULL");
        ...
        await queryRunner.query("ALTER TABLE `reglamentacion` DROP COLUMN `clasificacion`");
        await queryRunner.query("ALTER TABLE `reglamentacion` ADD `clasificacion` int NULL");
        await queryRunner.query("ALTER TABLE `contexto_politico` DROP COLUMN `clasificacion`");
        await queryRunner.query("ALTER TABLE `contexto_politico` ADD `clasificacion` int NOT NULL");
