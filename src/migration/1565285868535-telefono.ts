...
export class telefono1565285868535 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `municipalidad` DROP COLUMN `telefono`");
        await queryRunner.query("ALTER TABLE `municipalidad` ADD `telefono` mediumtext NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `municipalidad` DROP COLUMN `telefono`");
        await queryRunner.query("ALTER TABLE `municipalidad` ADD `telefono` varchar(255) NULL");
