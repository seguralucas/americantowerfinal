...
export class zss1565893338318 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `contexto_politico` CHANGE `puedeRelegir` `puedeRelegir` tinyint NULL");
        await queryRunner.query("ALTER TABLE `contexto_politico` CHANGE `cantidadMandatoMaxima` `cantidadMandatoMaxima` int NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `contexto_politico` CHANGE `cantidadMandatoMaxima` `cantidadMandatoMaxima` int NOT NULL");
        await queryRunner.query("ALTER TABLE `contexto_politico` CHANGE `puedeRelegir` `puedeRelegir` tinyint NOT NULL");
